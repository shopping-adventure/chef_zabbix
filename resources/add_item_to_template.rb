...
attribute :template_name, :kind_of => String, :name_attribute => true, :required => true
attribute :key_, :kind_of => String, :required => true
...
attribute :key__options, :kind_of => String
